...
module.exports = function createServer(port, sessionSecret, sessionDBFile, stateFile) {
  // Create express app
  var server = express();
  ...
  watcher.on("ready", function () {
    addAuthenticatedAPIRoutes(server, sessionSecret, sessionDBFile);
  });
  watcher.Start();
...
function addAuthenticatedAPIRoutes(server, sessionSecret, sessionDBFile) {
