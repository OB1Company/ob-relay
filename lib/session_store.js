...
// sessionStore manages authenticating users and creating/verifying sessions
function sessionStore(secret, dbFile) {
...
sessionStore.prototype.loginHandler = function (req, res) {
  var username = req.body.username,
    password = req.body.password;

  // If the credentials are valid create a jwt for 1 week
  // Othersise return an error
  _checkAuthentication(username, password).then(function (success) {
...
sessionStore.prototype.validator = function (req, res, next) {
